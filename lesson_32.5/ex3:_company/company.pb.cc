...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::Company
        {&::_pbi::kDescriptorMethods, &::descriptor_table_company_2eproto, /* tracker*/ nullptr,},
};
}  // namespace
#endif
...
constexpr Company::ParseTableT_ Company::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT_{
    {
      ...
      {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(Company, _impl_.foundation_year_), 3>(),
       {8, 3, 0,
      ...
      {::_pbi::TcParser::FastBS1,
       {34, 2, 0,
        PROTOBUF_FIELD_OFFSET(Company, _impl_.activity_type_)}},
      // optional bool foreign_economic_activity = 5;
      {::_pbi::TcParser::SingularVarintNoZag1<bool, offsetof(Company, _impl_.foreign_economic_activity_), 4>(),
       {40, 4, 0,
      ...
      // required int32 foundation_year = 1;
      {PROTOBUF_FIELD_OFFSET(Company, _impl_.foundation_year_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
      // required string legal_address = 2;
      ...
      // optional string activity_type = 4;
      {PROTOBUF_FIELD_OFFSET(Company, _impl_.activity_type_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kBytes | ::_fl::kRepAString)},
      // optional bool foreign_economic_activity = 5;
      {PROTOBUF_FIELD_OFFSET(Company, _impl_.foreign_economic_activity_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kBool)},
    }},
    // no aux_entries
    {{
    }},
...
constexpr auto Company::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(Company), alignof(Company));
}
...
struct CompanyGlobalsTypeInternal : ::_pbi::MessageGlobalsBase {
  constexpr CompanyGlobalsTypeInternal()
      :
#ifndef PROTOBUF_MESSAGE_GLOBALS
        _default(::_pbi::ConstantInitialized{},
                 Company_class_data_.base())
#else   // !PROTOBUF_MESSAGE_GLOBALS
        MessageGlobalsBase(Company::InternalGenerateClassData_(
            _default, &Company_globals_._table.header)),
        _default(::_pbi::ConstantInitialized{}, GetClassData()),
        _table(::_pbi::PrivateAccess::GenerateParseTable<Company>(
            GetClassData()))
#endif  // PROTOBUF_MESSAGE_GLOBALS
  {
  }
  ~CompanyGlobalsTypeInternal() {}
  union {
    alignas(::_pbi::kMaxMessageAlignment) Company _default;
  };
#ifdef PROTOBUF_MESSAGE_GLOBALS
  decltype(::_pbi::PrivateAccess::GenerateParseTable<Company>(
      ::std::declval<const ::_pbi::ClassData*>())) _table;
#endif
};
#ifdef PROTOBUF_MESSAGE_GLOBALS
static_assert(PROTOBUF_FIELD_OFFSET(CompanyGlobalsTypeInternal, _default) ==
              ::_pbi::MessageGlobalsBase::OffsetToDefault());
#endif  // PROTOBUF_MESSAGE_GLOBALS

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PROTOBUF_MESSAGE_GLOBALS_CONST CompanyGlobalsTypeInternal Company_globals_
        PROTOBUF_MESSAGE_GLOBALS_SECTION(.data.rel.ro);
#if defined(PROTOBUF_CUSTOM_VTABLE)
namespace {
const ::_pbi::ClassData* Company_get_class_data() {
#ifdef PROTOBUF_MESSAGE_GLOBALS
  return Company_globals_.GetClassData();
#else
...
const char descriptor_table_protodef_company_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\rcompany.proto\"\201\001\n\007Company\022\027\n\017foundatio"
    "n_year\030\001 \002(\005\022\025\n\rlegal_address\030\002 \002(\t\022\014\n\004n"
    "ame\030\003 \002(\t\022\025\n\ractivity_type\030\004 \001(\t\022!\n\031fore"
    "ign_economic_activity\030\005 \001(\010"
};
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, Company_get_class_data()) {
...
PROTOBUF_NDEBUG_INLINE Company::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::Company& from_msg)
      : _has_bits_{from._has_bits_},
        ...
        activity_type_(arena, from.activity_type_) {}
...
Company::Company(
  ...
  ::memcpy(reinterpret_cast<char*>(&_impl_) +
               offsetof(Impl_, foundation_year_),
...
inline void Company::SharedDtor(MessageLite& self) {
  ...
  this_._impl_.activity_type_.Destroy();
  this_._impl_.~Impl_();
}
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull Company_class_data_ =
        Company::InternalGenerateClassData_(Company_globals_._default);
...
PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
Company::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&Company_globals_);
  ::google::protobuf::internal::PrefetchToLocalCache(
      ::google::protobuf::internal::MessageGlobalsBase::ToParseTableBase(&Company_globals_));
  return Company_globals_.GetClassData();
}
#endif  // !PROTOBUF_MESSAGE_GLOBALS
#ifndef PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const Company::ParseTableT_
    Company::_table_ =
        Company::InternalGenerateParseTable_(Company_class_data_.base());
#endif  // !PROTOBUF_MESSAGE_GLOBALS
...
::uint8_t* PROTOBUF_NONNULL Company::_InternalSerialize(
  ...
  if (CheckHasBit(cached_has_bits, 0x00000008U)) {
    target =
        ::google::protobuf::internal::WireFormatLite::WriteInt32ToArrayWithField<1>(
            stream, this_._internal_foundation_year(), target);
  }
  ...
  // optional string activity_type = 4;
  if (CheckHasBit(cached_has_bits, 0x00000004U)) {
    const ::std::string& _s = this_._internal_activity_type();
  ...
  }
   {
    ...
    if (CheckHasBit(cached_has_bits, 0x00000008U)) {
      total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(
          this_._internal_foundation_year());
    }
  }
...
void Company::InternalSwap(Company* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.activity_type_, &other->_impl_.activity_type_, arena);
